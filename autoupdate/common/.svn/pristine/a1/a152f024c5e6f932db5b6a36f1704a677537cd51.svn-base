/*
 * $Header: /repo/common/dbconnect/driver_oracle/oracle_inc/ocikp.h,v 1.1.1.1 2010/04/29 03:15:23 platform Exp $
 */
...
/* 
   ...
   MODIFIED   (MM/DD/YY)
   chliang     06/16/03 - add OCIFetchRowCallback
...
in an array of structures (multi-row, multi-column) fetch.
...
of LOB. If the data is read in pieces, *amtp always contains the length of the 
last piece read.
...
sword   OCIStmtPrepare(/*_ OCIStmt *stmtp, OCIError *errhp, 
                           CONST OraText *stmt, ub4 stmt_len, 
                           ub4 language, ub4 mode _*/);
...
sword   OCIStmtFetch2(/*_ OCIStmt *stmtp, OCIError *errhp,
                         ub4 nrows, ub2 orientation, sb4 scrollOffset, 
                         ub4 mode _*/);
#endif /* __STDC__ */
...
sword OCIAnyDataGetType(/*_ OCISvcCtx *svchp, OCIError *errhp, 
        OCIAnyData *sdata, OCITypeCode *tc, OCIType **type _*/);

sword OCIAnyDataIsNull(/*_ OCISvcCtx *svchp, OCIError *errhp, 
        OCIAnyData *sdata, boolean *isnull _*/);
...
sword OCIAnyDataBeginCreate(/*_ OCISvcCtx *svchp, OCIError *errhp, 
        OCITypeCode tc, OCIType *type, OCIDuration dur, 
        OCIAnyData **sdata _*/);

sword OCIAnyDataDestroy(/*_ OCISvcCtx *svchp, OCIError *errhp, 
        OCIAnyData *sdata _*/);

sword OCIAnyDataAttrSet(/*_ OCISvcCtx *svchp, OCIError *errhp, 
        OCIAnyData *sdata, OCITypeCode tc, OCIType *type, dvoid *ind, 
        dvoid *attr_val, ub4 length, boolean is_any _*/);

sword OCIAnyDataCollAddElem(/*_ OCISvcCtx *svchp, OCIError *errhp,
        OCIAnyData *sdata, OCITypeCode tc, OCIType *type, dvoid *ind,
        dvoid *attr_val, ub4 length, boolean is_any, boolean last_elem _*/);

sword OCIAnyDataEndCreate(/*_ OCISvcCtx *svchp, OCIError *errhp, 
        OCIAnyData *sdata _*/);

sword OCIAnyDataAccess(/*_ OCISvcCtx *svchp, OCIError *errhp, 
        OCIAnyData *sdata, OCITypeCode tc, OCIType *type, dvoid *ind, 
        dvoid **attr_val, ub4 *length _*/);

sword OCIAnyDataGetCurrAttrNum(/*_ OCISvcCtx *svchp, OCIError *errhp, 
                OCIAnyData *sdata, ub4 *attrnum _*/);

sword OCIAnyDataAttrGet(/*_ OCISvcCtx *svchp, OCIError *errhp, 
        OCIAnyData *sdata, OCITypeCode tc, OCIType *type, dvoid *ind, 
        dvoid **attr_val, ub4 *length, boolean is_any _*/);

sword OCIAnyDataCollGetElem(/*_ OCISvcCtx *svchp, OCIError *errhp, 
        OCIAnyData *sdata, OCITypeCode tc, OCIType *type, dvoid *ind, 
        dvoid **celem_val, ub4 *length, boolean is_any _*/);
...
/*
   ...
   REMARKS
     ...
     bytes from str1 and len2 bytes from str2 are compared. The null-terminator
     will be taken into the comparison.
   RETURNS
     0, if str1 = str2
     Positive, if str1 > str2
     Negative, if str1 < str2
...
typedef sword (*OCIFetchRowCallback)(/*_ dvoid *ctx _*/);
